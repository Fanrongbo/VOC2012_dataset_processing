...
import os
import shutil
ann_filepath='./VOC2012/Annotations/'#origianl dataset directory
img_filepath='./VOC2012/JPEGImages/'#origianl dataset directory
img_savepath='./VOC2012_self/JPEGImages/'#creating new dataset directory
ann_savepath='./VOC2012_self/Annotations/'#creating new dataset directory
